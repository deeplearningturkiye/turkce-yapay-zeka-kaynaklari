Bu sayfada Türkiye'de derin öğrenme (deep learning) ve makine öğrenmesi (machine learning) alanında yapılan çalışmaları (blog yazısı, video ders, bilimsel makale, kodlar, verisetleri) bulabilirsiniz. Sayfa, **Deep Learning Türkiye** topluluğu tarafından desteklenmektedir. 

Derin öğrenme ve makine öğrenmesiyle ilgili **çalışmalarınız var ise** Deep Learning Türkiye topluluğuna katılmak için deeplearningturkiye@gmail.com adresine e-posta gönderebilirsiniz.
